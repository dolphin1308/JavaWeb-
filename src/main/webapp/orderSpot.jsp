...
<div style="margin-top: 100px;margin-left: 300px">
    <div id="page-inner">
        ...
        <div class="search">
            <h1>按景区</h1>
            <form id="doctor" action="searchSpot" method="post">
                <input  value="${spot}" name="spot"  autocomplete="off" class="" placeholder="查找景区">
                <input id="start" hidden value="1" name="start">
                <input id="order" hidden value="spot" name="order">
