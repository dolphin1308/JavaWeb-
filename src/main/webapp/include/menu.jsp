...
<div id="wrapper" class="toggled1 ">
    ...
    <div id="sidebar-wrapper1">
        <ul class="sidebar-nav1">
            ...
            <li><a class="list-group-item1" href="<%=request.getContextPath()%>/searchOffice"><font color="#fff">按地区预约</font></a></li>
            <li><a class="list-group-item1" href="<%=request.getContextPath()%>/searchSpot?order=spot"><font color="#fff">按景区预约</font></a></li>
