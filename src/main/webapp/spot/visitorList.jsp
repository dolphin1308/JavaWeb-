...
<div style="margin-top: 100px;margin-left: 300px">
    <div id="page-inner">
        <div class="container">
            <div class="h3 alert-info info">游客队列</div>
                ...
                <script>
                    $(function () {
                        $('#myModal').on('show.bs.modal', function (event) {
                            ...
                            var options="";
                            if(action=="finish"){
                                options+="<label><input  type='radio'>游客预约完成？</label></li>";
                            }else {
                                options+="<label><input  type='radio'>游客是否爽约？</label></li>";
                            }
                            $(".modal-body").empty();
