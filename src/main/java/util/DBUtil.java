...
public class DBUtil {
    ...
    public static void main(String[] args) {
        String sql="select visitor.name as pname,recode.ordertime,recode.state, recode.id as rid,numsource.serialnumber,numsource.nstime,workday.worktime\n" +
                "from workday,numsource,recode,patient where\n" +
                "workday.doctorid=? and workday.id=numsource.workdayid and numsource.id=recode.nid and recode.pid=visitor.id\n" +
