...
public class SendMail extends HttpServlet {
    ...
    protected void service(final HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (action){
            ...
            case "confirm":
                ...
                if(visitor !=null){
                    if(MyMail.sendMail(visitor.getEmail(),codeConfirm(code))){
    ...
    private String codeContent(int code){
        return "【在线预约系统】验证码是："+code+"<br>您正在使用注册功能，该验证码仅用于注册验证，请勿泄露给他人使用。5分钟内有效！<br>";
    }
    private String codeConfirm(int code){
        return "【在线预约系统】验证码是："+code+"<br>您正在使用预约功能，该验证码仅用于预约确认验证，请确定你的预约信息。<br>请勿泄露给他人使用。5分钟内有效！<br>";
    }
}
