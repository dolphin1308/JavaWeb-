    ...
    <div id="page-inner">
        <div class="container">
            ...
            <div class="ysjs ">
                <div class="title">
                    <div class="t">
                        <span><a href="showWeek?wid=${spot.did}">${spot.dname}</a></span>
                        <span class="career">${spot.career}</span>
                        <span class="career">${spot.age}历史</span>
                    </div>
                    ...
                    <form enctype="multipart/form-data" autocomplete="off" action='myInfo' method='post'>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input value="${spot.dname}" name="name"  class="form-control" id="name" placeholder="姓名">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="age" class="col-sm-2 control-label">历史</label>
                                <div class="col-sm-10">
                                    <input value="${spot.age}" type="number" name="age" class="form-control" id="age" placeholder="年龄">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="age" class="col-sm-2 control-label">描述</label>
                                <div class="col-sm-10">
                                    <textarea  id="description" name="description" class="form-control" rows="3">${spot.description}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
