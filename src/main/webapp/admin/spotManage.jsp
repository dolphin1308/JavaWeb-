...
<div style="margin-top: 100px;margin-left: 300px">
    <div id="page-inner">
        ...
        <div class="search">
            ...
            <form style="margin-top: 10px" id="office" action="spotManage" method="post">
                <input  value="${spot}" name="spot"  autocomplete="off" class="" placeholder="景区名字">
                <input  value="${office}" name="office"  autocomplete="off" class="" placeholder="地区名称">
                <input id="start" hidden value="1" name="start">
                <input  hidden value="query" name="action">
                <button type="submit">查找景区</button>
            </form>
            <style>
            .search{
                height:180px;
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" style="margin-top: 100px;" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action='spotManage' method='post'>
                        <input id="action" hidden value="add" name="action">
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="account" class="col-sm-2 control-label">景区管理员账号</label>
                                <div class="col-sm-10">
                                    <input   name="account" class="form-control" id="account" placeholder="景区账号">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="password" class="col-sm-2 control-label">景区管理员密码</label>
                                <div class="col-sm-10">
                                    <input   name="password" class="form-control" id="password" placeholder="景区密码">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name" class="col-sm-2 control-label">景区名称</label>
                                <div class="col-sm-10">
                                    <input   name="name" class="form-control" id="name" placeholder="景区名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="fee" class="col-sm-2 control-label">景区预约费</label>
                                <div class="col-sm-10">
                                    <input type="number" name="fee" class="form-control" id="fee" placeholder="景区预约费">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="age" class="col-sm-2 control-label">历史</label>
                                <div class="col-sm-10">
                                    <input type="number" name="age" class="form-control" id="age" placeholder="历史">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="offices" class="col-sm-2 control-label">地区</label>
                                <div class="col-sm-10" >
                            ...
                            <div class="form-group">
                                <label for="career" class="col-sm-2 control-label">景区级别</label>
                                <div class="col-sm-10" >
                            ...
                            <div class="form-group">
                                <label for="rooms" class="col-sm-2 control-label">街道办</label>
                                <div class="col-sm-10" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" >
                                    <textarea id="description" name="description" class="form-control" rows="3" placeholder="请输入景区描述信息"></textarea>
                                </div>
                            </div>
                        </div>
