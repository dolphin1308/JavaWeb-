...
<div style="margin-top: 100px;margin-left: 300px">
    <div wid="page-inner">
        <div class="container">
            ...
            <div class="ysjs ">
                <div class="title">
                    <div class="t">
                        ...
                        <span class="career">${spot.age}岁</span>
                    </div>
            ...
            <div class="h3 alert-info info">我的开放</div>
            <%--显示景区开放--%>
            <div class="schedule">
                <div class="week">
                    <div class="ysjj1">
                            ...
                            <form class="form-horizontal" action='applyWork' method='post'>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10" >
                                            <textarea id="reason" name="reason" class="form-control" rows="3" placeholder="请输入原因,例如场地清理"></textarea>
                                        </div>
                                    </div>
                                </div>
