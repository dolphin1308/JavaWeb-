            ...
            <div class="container1">
                ...
                <div class="left">
                    <form autocomplete="off" method="post" action="order">
                        ...
                        <table>
                            <tr><td>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</td><td>${sessionScope.visitor.name}</td></tr>
                            <tr><td>预约景区：</td><td>${spot.dname}</td></tr>
                            <tr><td>预约地区：</td><td>${spot.office}&nbsp;&nbsp;(${spot.room})</td></tr>
                            <tr><td>就诊时间：</td><td>${numSource.visitdate} ${numSource.visitnoon} ${numSource.visittime}第${numSource.serialnumber}号</td></tr>
                            <tr><td>预&nbsp;&nbsp;约&nbsp;&nbsp;费：</td><td>${spot.fee}.00元</td></tr>
                            <tr><td>你的邮箱：</td><td>${sessionScope.visitor.email}<button class="send">发送验证码</button></td></tr>
