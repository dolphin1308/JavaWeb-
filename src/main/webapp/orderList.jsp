                ...
                <c:forEach var="item" items="${requestScope.list}">
                    <div class="box">
                        ...
                        <table style="width: 28%">
                            <tr><td>景区：</td><td><a href="showWeek?did=${item.did}">${item.dname}</a></td></tr>
                            <tr><td>地区：</td><td><a href="searchOffice?office=${item.office}">${item.office}</a></td></tr>
                            <tr><td>具体：</td><td>${item.room}</td></tr>
                            <tr><td>门票：</td><td>${item.fee}.00元</td></tr>
                        </table>
                        <table>
                            <tr><td>预约时间：</td><td>${item.ordertime}</td></tr>
                            <tr><td>赴约时间：</td><td>${item.visitdate} ${item.visitnoon} ${item.visittime}</td></tr>
