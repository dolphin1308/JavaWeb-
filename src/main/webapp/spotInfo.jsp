...
<div style="margin-top: 100px;margin-left: 300px">
    <div id="page-inner">
        ...
        <div class="ysjs">
            ...
            <div class="title">
                <div class="t">
                    <span>${spot.dname}</span>
                    <span class="career">${spot.career}</span>
                    <span class="career">${spot.age}年历史</span>
                </div>
                <div class="b">
                    <span>${spot.office} （${spot.room}）</span><span>预约费：${spot.fee}</span>
                </div>
                <img src="${spot.picpath}">
            </div>
            <div class="content">
                <div >
                    <div>介绍：</div>
        ...
        <%--显示景区开放时间--%>
        <div class="container">
            <div class="row alert-info col-lg-8 h3">今天不能预约</div>
        </div>
        ...
        <div class="schedule">
            <div class="week">
                <div class="ysjj1">
                    <div style="width: 30%;">
                        <div class="ysjj">
                            <div class="title1">景区介绍</div>
                            <img src="${spot.picpath}">
                            <div class="title">
                                <div><span class="name">${spot.dname}</span><span class="career">${spot.career}</span></div>
                                <p>介绍：${spot.description}</p>
                            </div>
                            <div class="work">
                                <div>上午</div>
                                <div>下午</div>
                ...
                <div class="modal-dialog" style="margin-top: 200px;" role="document">
                    <div class="modal-content" style="width: 900px;left: -80px;">
                        ...
                        <form class="form-horizontal" action='order' method='post'>
                            ...
                            <input  hidden  name="did" value="${spot.did}">
                            ...
                            function(data){
                                ...
                                for(var i=0;i<data.length;i++){
                                    options+="<li class='"+data[i].state+"' ><label>" +
                                        ...
                                        "预约序号-"+data[i].serialnumber+"号 预约时间 - "+data[i].date+data[i].ampm+data[i].time+" "+data[i].state+"</label></li>"
                                }
                                $(".haoyuan ul").empty();
