...
<div style="margin-top: 100px;margin-left: 300px">
    <div id="page-inner">
        <div class="row alert-success h3 "style="padding: 20px">你当前的诚信度为：<div class="h1">${visitor.integrity}分</div></div></div>
        <c:if test="${requestScope.integrities != null}">
           <div class="container">
               <div class="row alert-info h4 "style="padding: 20px">诚信度记录</div>

               <table class="table table-hover">
                   <thead><tr><th>序号</th><th>景区</th><th>地区</th><th>时间</th><th>原因</th><th>分值</th></tr></thead>
