...
<html>
<head>
    <title>${office.officename}--在线预约系统</title>
...
<div style="margin-top: 100px;margin-left: 300px">
    <div id="page-inner">
        ...
        <div class="search">
            <h1>地区详情</h1>
            <form wid="doctor" action="searchSpot" method="post">
                <input  value="${spot}" name="spot"  autocomplete="off" class="" placeholder="在此地区下查找景区">
                ...
                <div class="ysjs">
                    <div class="title">
                        <div class="t">
                            ...
                            <span class="career">${item.age}年历史</span>
                        </div>
