...
<nav class="navbar1"
    ...
    <div class="container1">
        ...
        <div style="position: absolute; left: 150px; top: -2px;">
            <a class="navbar-brand1" href=""><font color="#fff">在线预约景区系统</font></a>
        </div>
        <div class="navbar-collapse1" id="top-navbar-1">
            <ul class="navbar-right1">
                <li>
                    <div>
                        <a class="navbar-brand1" style="font-size: 12px;" href="Chat.jsp"><strong>智能客服</strong></a>
                        ...
                        <c:if test="${sessionScope.visitor != null}">
                            <a class="navbar-brand1" style="font-size: 12px;" href=""><strong><font color="#fff">欢迎您,${sessionScope.visitor.name }</font></strong></a>
                            <a class="navbar-brand1" style="font-size: 12px;"
