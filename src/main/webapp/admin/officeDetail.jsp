                    ...
                    <form class="form-horizontal" action='officeDetail' method='post'>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="roomname" class="col-sm-2 control-label">地区名称</label>
                                <div class="col-sm-10">
                                    <input   name="roomname" class="form-control" id="roomname" placeholder="地区名称">
                                </div>
                            </div>
                        </div>
