    ...
    <div id="page-inner">
        <div class="ysjs">
            <div class="title">
                ...
                <div class="b">
                    <span>${doctor.office} （${doctor.room}）</span><span>预约费：${doctor.fee}</span>
                </div>
                ...
                <div class="ysjj1">
                    <div style="width: 30%;">
                        <div class="ysjj">
                            ...
                            <img src="${doctor.picpath}">
                            <div class="title">
                                <div><span class="name">${doctor.dname}</span><span class="career">${doctor.career}</span></div>
                ...
                <div class="modal-dialog" style="margin-top: 200px;" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">修改开放</h4>
                        </div>
                        <form class="form-horizontal" action='scheduleManage' method='post'>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="nsnum" class="col-sm-2 control-label">预约数</label>
                                    <div class="col-sm-10">
                                        <input name="nsnum" type="number" class="form-control" id="nsnum" placeholder="输入景区的预约数">
                                    </div>
                                </div>
                                <div class="form-group">
